...
serve(async (req) => {
  ...
  try {
    ...
    if (!botId) {
      console.error("No LINE Bot ID found for scenario");
    ...
    console.log("Redirecting to LINE URL:", lineUrl);
    ...
    try {
      ...
      console.error("Failed to log invite click:", logError);
    }
    ...
    console.error("Error in scenario-invite function:", error);
