...
serve(async (req) => {
  ...
  try {
    ...
    console.log('🚀 OAuth認証URL生成完了')
    console.log('Device Type:', isMobile ? 'Mobile (LINEアプリ起動)' : 'Desktop')
    console.log('Final URL:', finalAuthUrl.substring(0, 100) + '...')
