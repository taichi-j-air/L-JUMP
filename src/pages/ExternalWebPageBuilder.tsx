...
export default function ExternalWebPageBuilder() {
  ...
  return (
    <div className="max-w-[1200px] w-full space-y-4 px-4 ml-0 mr-auto">
      <header>
        ...
        <p className="text-muted-foreground">外部公開されるWEBページを作成します。</p>
      </header>
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {selected?.is_published ? "このページは公開されています" : "このページは非表示です（誰もアクセス不可）"}
                    </p>
                  </div>
